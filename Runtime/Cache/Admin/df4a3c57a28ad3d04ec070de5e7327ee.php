								...
								<div class="table-responsive">
									<table id="sample-table-1"
										...
										<?php if(is_array($recordList)): $i = 0; $__LIST__ = $recordList;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$result): $mod = ($i % 2 );++$i;?><tr>
												...
												<td><?php echo ($result["bt"]); ?></td>
												<td><?php echo ($result["pt"]); ?></td>
									...
									<div class="form-actions">							
										...
										<a href="/index.php/Admin/Keyword/showLink/page/<?php echo ($previousPage); ?>">上一页</a>
										<a href="/index.php/Admin/Keyword/showLink/page/<?php echo ($nextPage); ?>">下一页</a>
								</div>
